...
public class FRModule extends Command {
...
private CommandXboxController xboxController;
  ...
  public FRModule(Swerve d_Swerve, Gyro d_Gyro, QuadEncoders d_QuadEncoders, Controller d_Controller, CommandXboxController driverController) {
  ...
  public void execute() {
    ...
    if(controllermagnitude > joystickDeadband) {
      s_Swerve.setFRAzimuth(azimuthSpeed,azimuthdirection); //------------------------------------------
      s_Swerve.setFRDrive(driveSpeed,true); //------------------------------------------
      previousAzimuthDirection = azimuthdirection;
      previousDriveDirection = driveDirection;
    } else{
      s_Swerve.setFRAzimuth(0,previousAzimuthDirection);
